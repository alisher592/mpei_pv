...
class SunForecast():
    def __init__(self):
        self.X_scaler_filename = 'files/X_scaler_params.sca'
        self.y_scaler_filename = 'files/y_scaler_params.sca'
        self.location_lat = 56.11
        self.location_lon = 47.48
        self.location_tz = 'Europe/Moscow'
